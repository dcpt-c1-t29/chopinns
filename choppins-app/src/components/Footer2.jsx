            ...
            <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                  <div className="flex flex-col items-stretch w-1/5 mt-4 max-md:w-full max-md:ml-0">
                    <div className="flex flex-col items-stretch max-md:mt-10">
                      ...
                      <p className="text-zinc-900 text-lg mt-8"><a href="#">About Us</a></p>
                      ...
                      <p className="text-zinc-900 text-lg mt-6"><a href="#">Contact</a></p>
                      <p className="text-zinc-900 text-lg whitespace-nowrap mt-6">
                      <a href="#">
                        {" "}
                        Company{" "}
                  ...
                  <div className="flex flex-col items-stretch w-1/5 ml-5 mt-4  max-md:w-full max-md:ml-0">
                    <div className="flex flex-col items-stretch max-md:mt-10">
                      ...
                      <p className="text-zinc-900 text-lg mt-6"><a href="#">Privacy</a></p>
                      <p className="text-zinc-900 text-lg mt-6"><a href="#">Sitemap</a></p>
                    </div>
                  </div>
                  <div className="flex flex-wrap flex-col items-stretch w-[57%] ml-5 mt-4 max-md:w-full max-md:ml-0">
                    <div className="flex  flex-wrap flex-col items-stretch max-md:mt-10">
                      ...
                      <div className="flex flex-wrap items-stretch justify-between gap-4 mt-12 max-md:mt-10">
                        <input
                          type="text"
                          placeholder="Email"
                          className="text-zinc-900 text-sm bg-gray-300 focus:border-gray-300 focus:ring focus:ring-red-500 p-2 outline-none justify-center pl-6 pr-16 py-5 rounded-[38px] items-start max-md:px-5"
                        />
                        <button
                          className="text-white text-sm font-medium whitespace-nowrap bg-red-500 grow justify-center items-stretch px-7 py-5 rounded-[39px] max-md:px-5 transition-all duration-300 ease-in-out hover:bg-red-600"
